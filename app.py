...
ADJUSTMENTS = {
    1: {'x': -4, 'y': 4},  # Extremo derecho ceja izquierda
    2: {'x': -3, 'y': 2},   # Extremo izquierdo ceja izquierda
    3: {'x': 4, 'y': 0},  # Extremo derecho ceja derecha
    4: {'x': -29, 'y': -2}, # Extremo izquierdo ceja derecha
    5: {'x': 2, 'y': 1},  # Centro del ojo izquierdo
    6: {'x': -5, 'y': 0},  # Lado izquierdo ojo izquierdo
    7: {'x': 4, 'y': 3},   # Lado derecho ojo izquierdo
    8: {'x': -2, 'y': 3},   # Centro del ojo derecho
    9: {'x': -5, 'y': 0},  # Lado izquierdo ojo derecho
    10: {'x': 1, 'y': 2},  # Lado derecho ojo derecho
    ...
    15: {'x': -3, 'y': 1}   # Labio inferior derecho
}
