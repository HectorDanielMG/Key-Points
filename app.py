...
ADJUSTMENTS = {
    1: {'x': -0, 'y': 3},  # Extremo derecho ceja izquierda
    2: {'x': -0, 'y': 2},  # Extremo izquierdo ceja izquierda
    3: {'x': 3, 'y': 0},   # Extremo derecho ceja derecha
    4: {'x': -26, 'y': -2},# Extremo izquierdo ceja derecha
    5: {'x': 0, 'y': 0},   # Centro del ojo izquierdo
    6: {'x': -3, 'y': 0},  # Lado izquierdo ojo izquierdo
    7: {'x': 2, 'y': 3},   # Lado derecho ojo izquierdo
    8: {'x': -4, 'y': 1},  # Centro del ojo derecho
    9: {'x': -5, 'y': 1},  # Lado izquierdo ojo derecho
    10: {'x': 3, 'y': 1},  # Lado derecho ojo derecho
    11: {'x': -0, 'y': 2}, # Punta de la nariz
    12: {'x': -2, 'y': 2}, # Labio superior izquierdo
    13: {'x': -2, 'y': 2}, # Labio superior derecho
    14: {'x': -3, 'y': 0}, # Labio inferior izquierdo
    15: {'x': -1, 'y': 0}  # Labio inferior derecho
}
